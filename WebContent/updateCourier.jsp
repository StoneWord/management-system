...
%>
	<form action="updateCourier" method="post">
		
		<table align="center">
			<tr>
				<td>编号</td>
				<td><input type="text" name="ps_no" value="<%=courier.getPs_no() %>"></td>
			</tr>
			<tr>
				<td>姓名</td>
			...
			<tr>
				<td>配送数量</td>
				<td><input type="text" name="ps_num" value="<%=courier.getPs_num() %>"></td>
			</tr>
			<tr>
				<td>底薪</td>
				<td><input type="text" name="ps_salary" value="<%=courier.getPs_salary() %>"></td>
			</tr>
			<tr>
				<td>密码</td>
			...
			<tr>
				<td>公司编号</td>
				<td><input type="text" name="gs_no" value="<%=courier.getGs_no() %>"></td>
			</tr>
			<tr>
				<td colspan="2">
